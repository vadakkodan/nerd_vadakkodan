...
HD_PWD='/home/vadakkodan/Desktop/v_siso/siso/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log siso.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source siso.tcl -notrace
